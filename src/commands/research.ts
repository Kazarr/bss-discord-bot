...
export const researchCommand = new SlashCommandBuilder()
  .setName('research')
  .setDescription('Research and investigation notes');
...
export async function handleResearchCommand(
  ...
  try {
    ...
    console.error('Error creating research thread:', errorMessage);
